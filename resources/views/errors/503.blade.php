        ...
        <section class="error-page">
            <div class="container">
                <div class="error-page__content">
                    <h1 class="error-page__404"><img src="{{ asset('assets/images/resources/404.png') }}" alt="ogency"></h1><!-- 404 -->
                    <h4 class="error-page__title">Sitemizi geliştiriyoruz.</h4><!-- 404-title -->
                    <p class="error-page__text">En yakın zamanda hizmete sunacağız.</p><!-- 404-content -->
